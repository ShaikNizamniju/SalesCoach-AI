  ...
  return (
    <main style={{ position: "relative", zIndex: 1 }}>
      ...
      <section style={{ padding: "100px 40px 80px", maxWidth: 900, margin: "0 auto", textAlign: "center" }}>
        <div className="fade-up" style={{ display: "inline-flex", alignItems: "center", gap: 8, background: "rgba(0,229,160,0.08)", border: "1px solid rgba(0,229,160,0.2)", borderRadius: 20, padding: "5px 14px", marginBottom: 32 }}>
          <span style={{ width: 6, height: 6, borderRadius: "50%", background: "var(--accent)", display: "block" }} />
          <span style={{ fontSize: 12, color: "var(--accent)", fontFamily: "Syne, sans-serif", fontWeight: 600, letterSpacing: "0.06em" }}>BUILT WITH OPENAI CODEX</span>
        </div>
        <h1 className="fade-up-1" style={{ fontSize: "clamp(42px, 7vw, 72px)", lineHeight: 1.05, fontWeight: 800, letterSpacing: "-0.03em", marginBottom: 24 }}>
          Know exactly why<br /><span style={{ color: "var(--accent)" }}>you lost the deal.</span>
        </h1>
        <p className="fade-up-2" style={{ fontSize: 18, color: "var(--muted2)", maxWidth: 560, margin: "0 auto 48px", lineHeight: 1.7, fontWeight: 300 }}>
        ...
        <div className="fade-up-3" style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
          <Link href="/analyze"><button className="btn-primary" style={{ fontSize: 15, padding: "14px 32px" }}>Analyze your first call — free</button></Link>
          <Link href="/practice"><button className="btn-ghost" style={{ fontSize: 15, padding: "14px 32px" }}>Practice mode</button></Link>
        </div>
        <p className="fade-up-4" style={{ fontSize: 12, color: "var(--muted)", marginTop: 20 }}>No account needed · Results in 30 seconds · Supports MP3, WAV, M4A</p>
      </section>
      ...
      <section style={{ padding: "80px 40px", maxWidth: 900, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: 56 }}>
          <div className="tag" style={{ background: "rgba(0,229,160,0.08)", color: "var(--accent)", display: "inline-block", marginBottom: 16 }}>How it works</div>
      ...
      <section style={{ padding: "80px 40px", textAlign: "center", borderTop: "1px solid var(--border)" }}>
        ...
        <Link href="/analyze">
          <button className="btn-primary" style={{ fontSize: 16, padding: "16px 40px", marginBottom: 32 }}>Upload your call now →</button>
        </Link>
