...
function ResultsInner() {
  ...
  const shareToLinkedIn = () => {
    ...
    const url = "https://www.linkedin.com/sharing/share-offsite/?url=" + encodeURIComponent("https://sales-coach-ai-pi.vercel.app") + "&summary=" + encodeURIComponent(text);
      ...
      <div style={{ maxWidth: 800, margin: "0 auto", padding: "60px 24px" }}>
        ...
        <div className="fade-up-2" style={{ background: "rgba(255,77,77,0.05)", border: "1px solid rgba(255,77,77,0.2)", borderRadius: 16, padding: "28px", marginBottom: 24 }}>
          ...
          <div style={{ fontSize: 14, lineHeight: 1.7 }}>
            <span style={{ fontWeight: 500, color: "#ff6b6b" }}>Why this killed the deal: </span>{result.lostMoment.reason}
          </div>
        </div>
